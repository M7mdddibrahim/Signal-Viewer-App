...
class MyWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.actionChannel1.triggered.connect(self.drawg)
        ...
        self.graphWidget1 = MplCanvas(self, width=5, height=4, dpi=100)
        self.graphWidget2 = MplCanvas(self, width=5, height=4, dpi=100)
 ...
 #this is considerd the new load function using matplotlib
    def drawg(self):
        ...
        self.animation =animation.FuncAnimation(
            self.graphWidget1.figure, self.update_plot, frames=len(x), interval=1500, repeat=False)
